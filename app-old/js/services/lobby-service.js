        ...
        function ($rootScope, $state, $interval, $timeout, usernameFilter, LoopBackAuth, SocketService, ToastService) {
            ...
            function init(lobbyId) {
                ...
                conn = SocketService.new(
                    ...
                    function () {
                        // eslint-disable-next-line no-console
                        console.info('[INFO] disconnected');
                        connected = false;
            ...
            function connInitEvent(data) {
                ...
                $timeout(function () {
                    ...
                    slots = new Array(slotsMax);
                    players = p;
                    lobbyName = data.lobbyName;
                    lobbyCode = data.lobbyCode;
                    locked = data.locked;
                    lobbyPublic = data.public;
                });
            }
            ...
            function connLockEvent(data) {
                // eslint-disable-next-line no-console
                console.info('[INFO] event: lobby lock: ', data);
            ...
            function connPublicEvent(data) {
                // eslint-disable-next-line no-console
                console.info('[INFO] event: lobby public: ', data);
            ...
            function connJoinEvent(data) {
                // eslint-disable-next-line no-console
                console.info('[INFO] event: lobby join: ', data);
                $timeout(function () {
            ...
            function connPartEvent(data) {
                // eslint-disable-next-line no-console
                console.info('[INFO] event: lobby part: ', data);
            ...
            function connPromoteEvent(data) {
                // eslint-disable-next-line no-console
                console.info('[INFO] event: lobby promote: ', data);
            ...
            function connKickEvent(data) {
                if (data.userId === userId) {
                    // eslint-disable-next-line no-console
                    console.info('[INFO] kicked from lobby');
